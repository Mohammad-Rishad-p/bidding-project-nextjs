...
function SignUp() {
    return (
        <div className=' bg-slate-400 w-[40%] h-400 pb-4 '>
            {/* heading part */}
            <div className='flex items-center flex-col pb-4  text-white'>
                <h1 className='text-5xl'>Free Sign Up</h1>
            ...
            <form>
                ...
                <div className='flex gap-3 items-center justify-center text-white pb-4'>
                    ...
                    <label>I accept the<span className=' text-orange-600'> Terms and Conditions</span> and <span className=' text-orange-600'> Policy</span> of Easy bidder</label>
                </div>
                {/* signup button */}
